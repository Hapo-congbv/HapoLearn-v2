                        ...
                        <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.users.update', $user->id) }}">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-check-input ml-4" type="radio" name="role_id" id="1" value="{{ App\User::ROLE['user'] }}" {{ old('role', $user->role_id) ==  App\User::ROLE['user'] ? 'checked' : '' }}>
                                    <label for="1" class="ml-5">User</label>
                                    <input class="form-check-input ml-4" type="radio" name="role_id" id="2" value="{{ App\User::ROLE['teacher'] }}" {{ old('role',  $user->role_id) ==  App\User::ROLE['teacher'] ? 'checked' : '' }}>
